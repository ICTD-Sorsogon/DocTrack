                                ...
                                <template v-slot:default>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="subtitle-1">
                                                {{
                                                    document_record.document_type_id
                                                }}
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="subtitle-2">
                                                <strong
                                                    >Originating Office</strong
                                                >
                                            </td>
                                            <td class="subtitle-1">
                                                {{
                                                    document_record.originating_office
                                                }}
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td class="subtitle-1">
                                                {{
                                                    document_record.current_office
                                                }}
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td class="subtitle-1">
                                                {{
                                                    document_record.attachment_page_count
                                                }}
                                            </td>
                                        </tr>
                                        <tr>
