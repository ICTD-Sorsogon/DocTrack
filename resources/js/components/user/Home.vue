    ...
    <div v-if="auth_user.first_name">
        ...
        >
            ...
            <v-list>
                <v-list-item
                    :input-value="
                        $route.name === 'All Active Documents' ? true : false
                    "
                    link
                ...
                >
                    ...
                    <v-list-item
                        :input-value="
                            $route.name === 'Archive List' ? true : false
                        "
                        link
                    ...
                    <v-list-item
                        :input-value="
                            $route.name === 'Document Tracking Report'
                                ? true
                                : false
                        "
                        link
                    ...
                    <v-list-item
                        ...
                        :input-value="
                            $route.name === 'Office List' ? true : false
                        "
                        link
                    ...
                    <v-list-item
                        v-if="auth_user.role_id === 1"
                        :input-value="
                            $route.name === 'Log Report' ? true : false
                        "
                        link
                ...
                <v-list-item
                    :input-value="
                        $route.name === 'Account Settings' ? true : false
                    "
                    link
                    @click.prevent="getAccountSettings"
                >
                    <v-list-item-icon>
                ...
                <v-list-item
                    :input-value="
                        $route.name === 'User Management' ? true : false
                    "
                    v-if="auth_user.role_id === 1"
                    link
        ...
        <v-app-bar app color="#0675BB" dark>
            <v-app-bar-nav-icon
            ...
            <notification-item
                style="margin-top:580px; margin-left:200px"
                v-if="notif"
            ></notification-item>
            <notification
                v-on:showNotif="showNotif"
                style="margin-right:15px"
            ></notification>

            <router-link to="/account_settings">
                <v-avatar
                    v-if="image_source === '/storage/null'"
                    color="indigo"
                >
...
export default {
    ...
    computed: {
        ...
        currentRouteName() {
            if (this.$route.params.type) {
                let docTypes = this.$route.params?.type.replace(/\w/, val =>
                    val.toUpperCase()
                );
                return `${docTypes} Documents ${
                    docTypes == "Terminal" ? "Track" : ""
                }`;
            }
    ...
    created() {
        Echo.channel("documents" + this.auth_user.office_id).listen(
            "DocumentEvent",
            e => {
