                    ...
                    <v-col>
                        <v-list flat subheader>
                            ...
                            <v-list-item>
                                ...
                                <v-list-item-content>
                                    <v-list-item-title
                                        v-if="selected_document.is_external"
                                        >External</v-list-item-title
                                    >
                                    <v-list-item-title v-else
                                        >Internal</v-list-item-title
                                    >
                                </v-list-item-content>
                            </v-list-item>
                        </v-list>
                                ...
                                <v-list-item-content>
                                    <v-list-item-title>
                                        <v-tooltip
                                            ...
                                            v-for="destination in selected_document.destination"
                                            top
                                        >
                                            <template
                    ...
                    <v-col>
                        <v-list flat subheader>
                            ...
                            <v-list-item>
                                ...
                                <v-list-item-content>
                                    <v-list-item-title>{{
                                        selected_document.status.replace(
                                            /\w/,
                                            val => val.toUpperCase()
                                        )
                                    }}</v-list-item-title>
                        ...
                        <v-timeline align-top dense>
                            <v-timeline-item
                                ...
                                v-for="{
                                    ...
                                    remarks,
                                    touched_user
                                } in selected_document.tracking_records"
...
export default {
    ...
    computed: {
        ...
        originating_office_name({ selected_document }) {
            return (
                selected_document.origin_office?.name ??
                selected_document.originating_office
            );
        },
        sender_name({ selected_document }) {
            return (
                selected_document.sender?.name ?? selected_document.sender_name
            );
        }
    },
    methods: {
