...
export default {
    ...
    computed: {
        ...
        offices() {
            var data = JSON.parse(
                JSON.stringify(this.$store.state.offices.offices)
            );
            return data;
        },
        document_types() {
            var data = JSON.parse(
                JSON.stringify(this.$store.state.documents.document_types)
            );
            return data;
        },
        disableBtn() {
            return this.originating.length < 1 &&
                this.selected_type.length < 1 &&
    ...
    methods: {
        ...
        advanceExport() {
            const archive = this.$store.state.documents.documentsArchive[0]
                .selected;
        ...
        masterList() {
            const type = this.$store.state.documents.documentsArchive[0]
                .selected.filter;
            const data = this.$store.state.documents.documentsArchive[0]
                .selected[type.toLowerCase()].data;
