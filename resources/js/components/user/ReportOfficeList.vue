            ...
            <v-card-title primary-title>
                <v-toolbar flat>
                    ...
                    <v-btn
                        ...
                        dark
                        class="mb-2 ma-1"
                        @click.stop="openDialog('new_office')"
                    >
                    ...
                    <v-menu left bottom>
                        ...
                        <v-list>
                            <v-list-item
                                :key="1"
                                @click.stop="openDialog('import_office')"
                            >
                                <v-icon class="ma-1"
                            ...
                            <v-list-item
                                :key="2"
                                @click.stop="openDialog('export_office')"
                            >
                                <v-icon class="ma-1"
                ...
                <template v-slot:item.actions="{ item }">
                    <v-row>
                        ...
                        <v-col
                            ...
                            xl="6"
                            class="pl-0"
                            style="top:50%; text-align:left;"
                        >
                            <v-icon
                                small
                                @click="deleteConfirmationDialog(item)"
        ...
        <v-row justify="center">
            <v-dialog v-model="delete_dialog" persistent max-width="450px">
                <v-card color="grey lighten-2">
                    ...
                    <v-card-text>
                        Are you sure you want to delete office from the list?
                        <br />
                        <strong>- {{ delete_info.name }}</strong>
                    </v-card-text>
                    <v-card-actions>
                        <v-spacer></v-spacer>
                        <v-btn
...
export default {
    ...
    methods: {
        ...
        deleteOffice() {
            this.$store
                .dispatch("deleteOffice", this.delete_info.id)
                .then(() => {
