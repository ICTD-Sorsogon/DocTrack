<template>
    <div>
            ...
            <v-list three-line color="#E1F3FC">
                <template v-for="(item, index) in notifs">
                    ...
                    >
                        ...
                        <v-list-item :class="highlight(item.status)" ripple>
                            <v-list-item-avatar class="elevation-3">
                                <v-img
                                    :src="
                                        item.action == 'Reminder'
                                            ? baseURL + 'images/reminder.png'
                                            : baseURL + item.avatar ||
                            ...
                            <v-list-item-content>
                                ...
                                ></v-list-item-subtitle>
                                <h6
                                    style="font-weight:50; color: gray"
        ...
        <table-modal
            ...
            :dialog="dialog"
            v-if="Object.keys(selected_document).length"
    ...
    methods: {
        ...
        seen(index, item) {
            ...
            this.selected_document =
                Object.values(JSON.parse(JSON.stringify(this.documents)))
                    .flat()
                    .find(document => {
