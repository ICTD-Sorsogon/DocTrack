    ...
    <div>
        <v-row v-if="user && home">
            <v-col cols="12" xl="6" lg="6" md="6">
                <v-card class="mx-auto document_record_card" color="#E1EBEE">
                    <v-card-title>
                    ...
                    <v-card-text
                        class="font-weight-light document_record_card_text"
                    >
                        <span class="subtitle font-weight-bold">
                            <!-- TODO: Better presentation and wording of this description -->
                            Create a fresh document that will be added to the
                            inter-office document list. Only create a new
                            document if it does not exist in your office's
                            document database or if your office is the original
                            source of the document. If the document is from an
                            outside office, you can add the document in the
                            record by using this feature to include it in the
                            list of documents that your office is working on.
                        </span>
                    </v-card-text>
                    <v-card-actions align="right" justify="end">
            ...
            <v-col cols="12" xl="6" lg="6" md="6">
                <v-card class="mx-auto" color="#E1EBEE">
                    <v-card-title>
                        <span class="title font-weight-bold"
                            >Receive Document</span
                        >
                    </v-card-title>
                    <v-divider class="mx-4"></v-divider>
                    <v-card-text
                    ...
                    >
                        <span class="subtitle font-weight-bold">
                            Receive an existing document routed to your office
                            by scanning or entering the document routing number
                        </span>
                    </v-card-text>
            ...
            <v-col cols="12" xl="6" lg="6" md="6">
                <v-card class="mx-auto" color="#E1EBEE" max-width="100%">
                    <v-card-title>
                        <span class="title font-weight-bold"
                            >Forward Document</span
                        >
                    </v-card-title>
                    <v-divider class="mx-4"></v-divider>
                    <v-card-text
                    ...
                    >
                        <span class="subtitle font-weight-bold"
                            >Forward an existing document to another
                            office</span
                        >
                    </v-card-text>
                    <v-card-actions align="right" justify="end">
            ...
            <v-col cols="12" xl="6" lg="6" md="6">
                <v-card class="mx-auto" color="#E1EBEE" max-width="100%">
                    ...
                    >
                        <span class="subtitle font-weight-bold"
                            >Set an existing document as terminal</span
                        >
                    </v-card-text>
