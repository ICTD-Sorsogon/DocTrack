            ...
            <v-card-title primary-title>
                <v-toolbar flat>
                    ...
                    <v-btn
                        ...
                        dark
                        class="mb-2 ma-1"
                        @click.stop="exportUser"
                    >
                        <v-icon medium left>mdi-file-export-outline</v-icon>
                        Export
                    </v-btn>
                </v-toolbar>
            </v-card-title>
                ...
                <v-card color="grey lighten-2">
                    ...
                    <v-card-actions>
                        ...
                        <v-btn
                            color="primary darken-1"
                            text
                            @click.prevent="deleteExistingUser"
                        >
                            Confirm
                        </v-btn>
                    </v-card-actions>
    ...
    methods: {
        ...
        save() {
            if (this.editedIndex > -1) {
                ...
                this.$store
                    .dispatch("updateExistingUser", this.form)
                    .then(() => {
        ...
        deleteExistingUser() {
            this.$store
                .dispatch("deleteExistingUser", this.form.id)
                .then(() => {
                    if (this.request.status == "SUCCESS") {
                        this.$store
                            .dispatch("setSnackbar", {
